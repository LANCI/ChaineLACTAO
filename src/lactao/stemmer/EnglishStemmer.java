...
public class EnglishStemmer implements Stemmer {
	...
	public String stem(String word) {
		...
		if (result.equals("evolut") || result.equals("evolv"))
			result = "evol";
		return result;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(s.stem("evolution"));
		System.out.println(s.stem("evolve"));
		System.out.println(s.stem("evolving"));
		System.out.println(s.stem("evolves"));
		System.out.println(s.stem("evolved"));
	}
}
